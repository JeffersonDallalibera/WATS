...
def test_platform_specific_features():
    ...
    try:
        from wats.utils.platform_utils import (
            IS_WINDOWS, IS_LINUX, get_platform_info, 
            get_platform_specific_paths, ensure_platform_dirs
        )
        ...
        print(f"Diretórios da plataforma:")
...
def main():
    ...
    tests = [
        test_freerdp_wrapper,
        test_rdp_connector_priority, 

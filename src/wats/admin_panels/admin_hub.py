...
class AdminHubDialog(ctk.CTkToplevel):
    ...
    def __init__(self, parent, db: DBService):
        ...
        lbl_title = ctk.CTkLabel(
            self, text="Painel de Administração", font=("Segoe UI", 18, "bold")
        )
        ...
        btn_manage_users = ctk.CTkButton(
            self,
            text="👤 Gerenciar Usuários e Permissões",
            height=45,
        ...
        btn_manage_connections = ctk.CTkButton(
            self,
            text="🖥️ Gerenciar Conexões (Bases)",
            height=45,
        ...
        btn_temporary_access = ctk.CTkButton(
            self,
            text="🕐 Permissões Temporárias",
            height=45,
            command=self._open_temporary_access_manager,
            state="normal",
            fg_color="orange",

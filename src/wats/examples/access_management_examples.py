...
class AccessManagementExamples:
    ...
    def exemplo_acesso_temporario_renovavel(self):
        ...
        sucesso_restore, msg_restore = self.access_service.restaurar_acesso_grupo(user_id, conexao_id)
    ...
    while True:
        ...
        try:
            ...
            if opcao == "0":
                ...
                menu_liberar_permanente(access_service)
            elif opcao == "3":
                menu_bloquear_acesso(access_service)
            elif opcao == "4":
                menu_restaurar_grupo(access_service)
            elif opcao == "5":
                menu_verificar_status(access_service)
            elif opcao == "6":
                menu_renovar_acesso(access_service)
            elif opcao == "7":
                menu_relatorio_usuario(access_service)
            elif opcao == "8":
                menu_listar_conexao(access_service)
            else:

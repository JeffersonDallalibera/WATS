...
class FilterableTreeFrame(ctk.CTkFrame):
    ...
    def _apply_treeview_theme(self):
        ...
        try:
            ...
            self.style.configure("Filterable.Treeview",
                                background=bg_color,
                                foreground=fg_color,
                                rowheight=25,
            ...
            self.style.configure("Filterable.Treeview.Heading",
                                background="#404040" if ctk.get_appearance_mode() == "Dark" else "#f0f0f0",
                                foreground=fg_color,
                                relief="flat")
            
            self.style.map("Filterable.Treeview",
    ...
    def _apply_filter(self, filter_text: str):
        ...
        if not filter_text:
            ...
            self.filtered_data = [
                ...
                if self._item_matches_filter(item, filter_text)
            ]

...
class ApiIntegrationManager:
    ...
    def __init__(self, settings):
        ...
        self.on_upload_completed: Optional[Callable[[str, str], None]] = (
            None  # (task_id, server_file_id)
        )
    ...
    def upload_older_recordings(
        self, recordings_dir: Path, max_age_days: Optional[int] = None
    ) -> List[str]:
        """

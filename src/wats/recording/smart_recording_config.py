...
def get_smart_recording_config(
    config_dict: Dict[str, Any] = None, user_settings=None
) -> Dict[str, Any]:
    """
    ...
    if config_dict:
        ...
        config_mappings = {
            ...
            "smart_recording": {
                ...
                "compression_cr": "compression_crf",
...
def create_default_config_file(file_path: str):
    ...
    config_data = {
        ...
        "documentation": {
            ...
            "compression_cr": "H.264 CRF value (0-51, lower is better quality)",
        },
    }

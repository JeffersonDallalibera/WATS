...
class AccessManagementService:
    ...
    def liberar_acesso_temporario(self, user_id: int, conexao_id: int, 
                                 responsavel: str, horas_duracao: int = 24, 
                                 motivo: str = None) -> Tuple[bool, str]:
        """
        ...
        try:
            ...
            if sucesso:
                logging.info(f"[ACCESS_MGMT] Acesso temporário liberado: Usuário {user_id} -> Conexão {conexao_id} por {horas_duracao}h")
    ...
    def liberar_acesso_permanente(self, user_id: int, conexao_id: int, 
                                 responsavel: str, motivo: str = None) -> Tuple[bool, str]:
        """
        ...
        try:
            ...
            if sucesso:
                logging.info(f"[ACCESS_MGMT] Acesso permanente liberado: Usuário {user_id} -> Conexão {conexao_id}")
    ...
    def bloquear_acesso_usuario(self, user_id: int, conexao_id: int, 
                               responsavel: str, motivo: str = None) -> Tuple[bool, str]:
        """
        ...
        try:
            ...
            if sucesso:
                logging.info(f"[ACCESS_MGMT] Acesso bloqueado: Usuário {user_id} -> Conexão {conexao_id}")
    ...
    def restaurar_acesso_grupo(self, user_id: int, conexao_id: int) -> Tuple[bool, str]:
        ...
        try:
            ...
            if sucesso:
                logging.info(f"[ACCESS_MGMT] Acesso restaurado para grupo: Usuário {user_id} -> Conexão {conexao_id}")
    ...
    def renovar_acesso_temporario(self, user_id: int, conexao_id: int, 
                                 responsavel: str, novas_horas: int = 24) -> Tuple[bool, str]:
        """
        ...
        try:
            ...
            if sucesso:
                logging.info(f"[ACCESS_MGMT] Acesso renovado: Usuário {user_id} -> Conexão {conexao_id} por {novas_horas}h")
    ...
    def relatorio_acessos_por_usuario(self, user_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "acessos_liberados": sum([contadores["ADMIN"], contadores["GRUPO"], contadores["INDIVIDUAL_LIBERADO"]]),

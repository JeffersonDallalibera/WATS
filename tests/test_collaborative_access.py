...
def test_password_generation():
    ...
    try:
        from src.wats.collaborative_access import CollaborativeAccessDialog
...
def test_collaborative_dialog_import():
    ...
    try:
        from src.wats.collaborative_access import CollaborativeAccessDialog, temp_password_validator
        print("✅ CollaborativeAccessDialog importado com sucesso")

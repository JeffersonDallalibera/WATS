...
def test_settings_class_integration():
    ...
    try:
        ...
        from src.wats.config import load_environment_variables, Settings
        ...
        if settings.validate_recording_config():
            ...
            print("⚠️  Validação da configuração de gravação falhou (pode ser normal se recording estiver desabilitado)")
...
def test_custom_output_dir():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            importlib.reload(wats_app.config)
            ...
            if settings.RECORDING_OUTPUT_DIR == custom_path:
                ...
                print(f"❌ ERRO: Esperado '{custom_path}', obtido '{settings.RECORDING_OUTPUT_DIR}'")
                return False

...
def test_directory_creation():
    ...
    try:
        ...
        for test_path in test_paths:
            ...
            if not os.path.exists(expanded_path):
                ...
                if os.path.exists(expanded_path):
                    ...
                    print(f"     ❌ Falha na criação do diretório")
            else:
                print(f"     ⚠️ Diretório já existe")
        ...
        try:
            ...
            print(f"🧹 Limpeza: Diretório de teste removido")
        except Exception as e:
...
def test_real_user_paths():
    ...
    for path in real_paths:
        ...
        if parent_exists and not exists:
            print(f"     🔨 Pode ser criado: ✅")
        elif not parent_exists:
            print(f"     🔨 Pasta pai precisa ser criada primeiro")
